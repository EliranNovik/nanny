-- Optimization: Include enriched profile and stats data directly in the discover help requests RPC.
-- This eliminates multiple parallel network requests from the frontend hooks.
