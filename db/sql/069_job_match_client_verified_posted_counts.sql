-- Freelancer job match: client verification + lifetime posted requests count.
...
comment on function public.get_job_requests_near_location(double precision, double precision, double precision, text[], uuid, int) is
  'Freelancer matching: open job_requests near location; includes client verification + lifetime posted counts.';
