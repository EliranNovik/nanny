-- Open help requests for Discover "Help others": posted via I need help / create flow,
-- not linked to community availability posts (community_posts).
...
comment on function public.get_discover_open_help_requests(int) is
  'Discover strip: open job_requests from the create-request flow (community_post_id is null).';
