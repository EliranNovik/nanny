...
export const CLIENT_PAGE_SUGGESTIONS: SmartSearchSuggestion[] = [
  ...
  },
  {
    ...
    keywords: ["live", "active jobs", "current jobs", "ongoing"],
    icon: Briefcase,
  },
  {
    id: "jobs-past",
    ...
    keywords: ["past", "history", "completed", "done"],
    icon: CheckCircle2,
  },
  {
    id: "community",
...
export const FREELANCER_PAGE_SUGGESTIONS: SmartSearchSuggestion[] = [
  ...
  },
  {
    ...
    keywords: ["incoming", "requests", "leads", "new", "bell", "notifications jobs"],
    icon: Bell,
  },
  {
    id: "pending",
    ...
    keywords: ["pending", "waiting", "hourglass"],
    icon: Hourglass,
  },
  {
    id: "jobs-live",
    ...
    keywords: ["live", "active", "current", "ongoing"],
    icon: Briefcase,
  },
  {
    id: "jobs-past",
    ...
    keywords: ["past", "history", "completed"],
    icon: CheckCircle2,
  },
  {
    id: "inbox",
