              ...
              <div className="space-y-10">
                {reviews.length > 0 ? reviews.map((review, idx) => {
                  ...
                  return (
                    <div
                      key={review.id}
                      className="relative bg-white dark:bg-zinc-900 rounded-3xl border border-gray-100 dark:border-white/5 shadow-xl p-8 pt-14 mt-10 hover:shadow-2xl transition-all duration-500 group"
                    >
                      {/* Floating Avatar */}
                      <div className={cn(
