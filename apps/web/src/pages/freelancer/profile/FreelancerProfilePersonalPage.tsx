  ...
  return (
    <ProfileSubpageLayout title="Personal & contact" description="How you appear and how others can reach you">
      <div className="space-y-8">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
            <Avatar className="h-24 w-24 border border-border/50">
              ...
              <AvatarFallback className="bg-muted text-2xl font-semibold text-primary">{initials}</AvatarFallback>
            </Avatar>
          ...
          <ViewEditFieldRow
            ...
            editContent={
              <>
                ...
                <Input id="fullName" placeholder="Your name" className={inputEdit} value={ctx.fullName} onChange={(e) => ctx.setFullName(e.target.value)} />
              </>
            }
          />
          ...
          <ViewEditFieldRow
            ...
            editContent={
              <>
                ...
                <p className="text-xs text-muted-foreground">Use GPS to detect your city</p>
              </>
            }
          />
        </div>
              ...
              <>
                ...
                <div className="flex items-center justify-between pt-2">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-muted-foreground">Allow contact on WhatsApp</p>
                  </div>
                  <Switch
                    id="share-whatsapp"
              ...
              <>
                ...
                <div className="flex items-center justify-between pt-2">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-muted-foreground">Allow contact on Telegram</p>
                  </div>
                  <Switch
                    id="share-telegram"
        ...
        {!editing && <p className="text-center text-[13px] text-muted-foreground">Tap Edit to update your details</p>}
      </div>
