  ...
  const showcaseCategories = [
    {
      ...
      details: "Watch how easy it is to connect with trusted helpers in your neighborhood. Fast, secure, and seamless.",
      bullets: ["Instant Matching", "Secure Direct Chat", "Verified Profiles", "Easy Management"],
      cta: "Get Started Now"
    },
    {
      id: "childcare",
      ...
      details: "Meet verified nannies and babysitters who feel right for your family. From nannies to emergency sitters.",
      bullets: ["Vetted & Background Checked", "CPR Certified Options", "Flexible Scheduling", "Real-time Availability"],
      cta: "Hire a Nanny"
    },
    {
      id: "cleaning",
      ...
      bullets: ["Vetted housekeepers", "Environmentally friendly options", "Same-day availability available"],
      details: "Our cleaning professionals are dedicated to making your home shine. From deep cleans to regular upkeep, we handle the dust so you can handle the rest.",
    ...
    },
    {
      ...
      details: "Find talented home cooks and chefs for daily meal prep or special dinner parties. Customizable to your tastes.",
      bullets: ["Dietary Specialists", "Grocery Shopping Included", "Kitchen Cleanup", "Fresh Ingredients"],
      cta: "Hire a Chef"
    },
    {
      id: "pickup",
      ...
      details: "From groceries to dry cleaning, our reliable couriers pick up and deliver essentials right to your door.",
      bullets: ["Fast Point-to-Point", "Real-time Tracking", "Careful Handling", "Available 24/7"],
      cta: "Hire a Courier"
    },
    {
      id: "handyman",
      ...
      details: "Need help organizing, assembling, or fixing? Our versatile helpers tackle any home task with precision.",
      bullets: ["Versatile Skillsets", "On-Demand Tasks", "Creative Problem Solvers", "Project-Based Rates"],
      cta: "Find a Helper"
    }
  ];
  ...
  return (
    <div className="min-h-screen gradient-mesh flex flex-col">
      ...
      <div className={cn(
        ...
        showFixedButtons ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10 pointer-events-none"
      )}>
        <Button
      ...
      <main className="flex-1 pt-0">
        ...
        <section ref={heroRef} className="relative w-full min-h-[90vh] overflow-hidden group/hero">
          ...
          <div ref={buttonsRef} className="hidden md:flex absolute right-12 lg:right-32 top-1/2 -translate-y-1/2 flex-col items-center gap-8 z-20">
            <Button
              onClick={handleSearchingForJob}
            ...
            >
              ...
              <div className="text-center">
                <span className="block text-xl font-black text-slate-900 uppercase tracking-tight leading-tight">Be the helper</span>
                <span className="block text-[11px] font-bold text-slate-500 uppercase tracking-widest opacity-80 mt-1">Join our network</span>
              </div>
            </Button>
            ...
            >
              ...
              <div className="text-center">
                <span className="block text-xl font-black uppercase tracking-tight leading-tight">Hire a Helper</span>
                <span className="block text-[11px] font-bold text-orange-50/70 uppercase tracking-widest mt-1">Post a request</span>
              </div>
            </Button>
          </div>
        </section>
          ...
          <section className="scroll-reveal opacity-0 translate-y-10 transition-all duration-1000 delay-300 py-24 overflow-hidden">
            <div className="max-w-7xl mx-auto px-3 sm:px-4">
              <div className="text-center mb-16 space-y-4 px-1 sm:px-0">
                ...
                <p className="text-slate-500 font-medium text-lg max-w-2xl mx-auto">
                  Find the perfect helper for any task, with all the details at your fingertips.
                </p>
              </div>
                ...
                <div className="relative w-full md:w-[92%] max-w-[1400px] mx-auto flex items-center justify-center">
                  ...
                  <div className="flex items-end justify-center w-full gap-1 sm:gap-3 md:gap-8 px-0">
                    {showcaseCategories.map((cat, idx) => {
                      ...
                      const isNext = idx === (activeCategoryIndex + 1) % showcaseCategories.length;
                            ...
                            isActive
                             ...
                             <div className="relative w-full h-full">
                               ...
                               <div className={cn(
                                 ...
                                 isActive ? "from-black/90 via-black/20 to-transparent" : "from-black/60 to-transparent"
                               )}></div>
                               ...
                               <div className={cn(
                                 ...
                                 isActive ? "bottom-4 md:bottom-10" : "bottom-3 md:bottom-6"
                               )}>
                                 <div className="flex items-center gap-2 md:gap-3 mb-1 md:mb-2">
                                   <div className={cn(
                                     "p-1.5 md:p-2 rounded-lg md:rounded-xl backdrop-blur-md bg-white/20 border border-white/30 text-white",
                                     isActive ? "h-7 w-7 md:h-10 md:w-10" : "h-5 w-5 md:h-8 md:w-8"
                                   )}>
                                     {React.cloneElement(cat.icon as React.ReactElement, { className: "w-full h-full text-white" })}
                                   </div>
                                   <h3 className={cn(
                                     "font-black !text-white uppercase tracking-tighter leading-none drop-shadow-md",
                                     isActive ? "text-xl md:text-5xl" : "text-sm"
                                   )}>
                                     {cat.title}
                                   </h3>
                                 </div>
                ...
                <div className="mt-8 w-full max-w-5xl animate-in fade-in slide-in-from-top-4 duration-700">
                  <div className="space-y-12 text-center sm:text-left py-8 px-4 md:px-0 max-h-[700px] overflow-y-auto scrollbar-hide">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                      ...
                      <div className="space-y-4">
                        <h5 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Why Choose Us?</h5>
                        <ul className="space-y-3">
                          {showcaseCategories[activeCategoryIndex].bullets.map((bullet, i) => (
                            <li key={i} className="flex items-center gap-3 text-slate-700 font-bold justify-center sm:justify-start">
                    ...
                    <div className="pt-8 border-t border-slate-200/50 flex flex-col sm:flex-row items-center justify-between gap-6">
                      <div className="hidden sm:block">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-bold text-slate-700 tracking-tight">Active matches in your area</span>
                        </div>
                      </div>
                      <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                        <Button onClick={handleHiringHelper} size="lg" className="h-14 px-10 rounded-2xl font-bold bg-primary hover:bg-primary/90 text-white shadow-xl shadow-primary/20 text-lg transition-all hover:scale-105 active:scale-95 w-full sm:w-auto">
