...
import { BadgeCheck, Clock, Heart, MessageSquare, Share2 } from "lucide-react";
...
export function CommunityPostCard({
  ...
  const tightenIconRowToImage = Boolean(
    plain && iconOnlyActions && imageUrls.length > 0,
  );
      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              className={cn(
                splitDesktopImageCard && "flex min-h-0 flex-col md:flex-none",
              )}
            >
              <div
                className={cn(
                  ...
                  sheetComfort &&
                    "max-md:gap-4 max-md:px-5 max-md:pt-6 max-md:pb-1",
              ...
              <div
                className={cn(
                  ...
                  noImagePublicFeed &&
                    "max-md:space-y-5 max-md:px-4 max-md:pb-6",
              ...
              >
                ...
                {plain && imageUrls.length === 0 && (
                  <div
                    className={cn(
                      "flex justify-start pt-1",
                      sheetComfort && "max-md:pt-2",
                    )}
                  >
                    <PostTimeLeftBadge expiresAtIso={post.expires_at} />
                  </div>
              ...
              plain
                ? tightenIconRowToImage
                  ? cn(
                      ...
                      sheetComfort &&
                        "max-md:space-y-4 max-md:px-5 max-md:pb-6 max-md:pt-4",
                      splitDesktopImageCard &&
                        "md:space-y-2 md:px-4 md:pb-2 md:pt-2",
                    )
                  : largePublicIconRow
                    ? cn(
