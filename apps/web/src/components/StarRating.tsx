    ...
    <div className={cn("flex items-center gap-1", className)}>
            ...
            >
              ...
              <Star
                className={cn(
                  sizeClasses[size],
                  emptyStarClassName ||
                    "text-slate-900/20 dark:text-neutral-500/35",
                )}
                fill="none"
              />
      ...
      <div className={cn("flex items-center gap-1", textSizeClasses[size])}>
        <span
          className={cn(
            "font-black",
            numberClassName || "text-slate-900 dark:text-slate-100",
          )}
        >
        ...
        {showCount && totalRatings !== undefined && totalRatings > 0 && (
          <span
            className={cn("text-slate-600 dark:text-slate-400", countClassName)}
          >
            ({totalRatings})
          </span>
        )}
