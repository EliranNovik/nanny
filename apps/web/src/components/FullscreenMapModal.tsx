                        ...
                        {(otherUser.rating || otherUser.average_rating) > 0 && (
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-[10px] font-bold text-slate-500">
                              {(
                                otherUser.rating || otherUser.average_rating
                              ).toFixed(1)}
                            </span>
                          </div>
                        )}
                        <p className="text-[10px] font-bold text-orange-500 uppercase tracking-widest">
                          {isPickupDelivery && routeInfo
            ...
            <div className="space-y-6 pt-4 animate-in fade-in duration-500">
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <StarRating
                          ...
                          totalRatings={
                            otherUser.totalRatings || otherUser.total_ratings
                          }
                          size="sm"
                        />
                      </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-slate-50 dark:bg-zinc-800/50 p-4 rounded-3xl border border-black/5 dark:border-white/5 flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-xs font-bold text-slate-900 dark:text-white capitalize leading-none">
                    {job.care_type || job.service_type?.replace(/_/g, " ")}
                  </span>
                </div>
                <div className="bg-slate-50 dark:bg-zinc-800/50 p-4 rounded-3xl border border-black/5 dark:border-white/5 flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-xs font-bold text-slate-900 dark:text-white capitalize leading-none">
                    {job.care_frequency?.replace(/_/g, " ") || "One-time"}
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-4 pt-4 border-t border-black/5 dark:border-white/5">
                <div className="flex items-center justify-between">
                  ...
                  {routeInfo && (
                    <div className="flex items-center gap-2">
                      <Badge className="bg-orange-500/10 text-orange-600 border-none font-bold text-[10px] uppercase tracking-wider">
                        {routeInfo.distance}
                      </Badge>
                      <Badge className="bg-blue-500/10 text-blue-600 border-none font-bold text-[10px] uppercase tracking-wider">
                        {routeInfo.duration}
                      </Badge>
                    </div>
                  )}
                ...
                <div className="space-y-3">
                  {job.service_details?.from_address && (
                    <div className="flex items-start gap-4 p-4 bg-slate-50 dark:bg-zinc-800/50 rounded-3xl border border-black/5 dark:border-white/5">
                      ...
                      <div>
                        <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest mb-1 leading-none">
                          PICKUP
                        </p>
              ...
              <div className="pt-2">
                {job.service_details?.custom && (
                  <div className="p-4 bg-slate-50 dark:bg-zinc-800/50 rounded-3xl border border-black/5 dark:border-white/5 mb-4">
                    ...
                    <p className="text-sm font-semibold text-slate-700 dark:text-slate-200 leading-snug whitespace-pre-wrap">
                      {job.service_details.custom}
                    </p>
                  </div>
                )}
                <p className="text-[10px] font-bold text-slate-400 text-center uppercase tracking-[0.2em] mb-4">
