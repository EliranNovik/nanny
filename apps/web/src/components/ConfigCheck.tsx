      ...
      <Card className="max-w-lg border-destructive/50 border-2">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Your Supabase credentials are not configured. Please update your
...
VITE_API_BASE_URL=http://localhost:4000`}
          ...
          <div className="bg-muted p-4 rounded-lg space-y-2 text-sm">
            ...
            <ol className="list-decimal list-inside space-y-1 ml-2">
              ...
              <li>
                Copy <strong>anon public</strong> key →{" "}
          ...
          <p className="text-xs text-muted-foreground">
            After updating, restart the dev server (stop with Ctrl+C, then run{" "}
