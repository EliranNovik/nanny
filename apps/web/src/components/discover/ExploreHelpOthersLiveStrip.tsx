  ...
  if (loading && !fp) {
    return (
      <div
        ...
        aria-hidden
      >
        <div className="mx-auto h-9 max-w-lg animate-pulse rounded-xl bg-zinc-200/80 dark:bg-zinc-800/80" />
      </div>
    );
  }
        ...
        {isLive ? (
          ...
          >
            <div className="flex min-w-0 flex-1 items-center gap-2">
              <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-emerald-500/12 dark:bg-emerald-400/10">
                <span className="relative flex h-3 w-3 shrink-0">
                  <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-emerald-400 opacity-60 motion-reduce:animate-none" />
                  <span className="relative inline-flex h-3 w-3 rounded-full bg-emerald-500 shadow-sm ring-2 ring-white dark:ring-emerald-950/80" />
                </span>
              </span>
              <div className="min-w-0">
                ...
                <p className="truncate text-[12px] font-semibold leading-snug text-emerald-800/90 dark:text-emerald-200/85">
            ...
            <div className="flex shrink-0 items-center gap-1.5">
              {timerAnchorIso ? (
                <div className="rounded-lg bg-emerald-50 px-2 py-1 text-[12px] font-bold tabular-nums text-emerald-900 shadow-sm ring-1 ring-emerald-600/15 dark:bg-emerald-900/50 dark:text-emerald-100 dark:ring-emerald-400/15">
                  <LiveTimer
          ...
          >
            <div className="flex min-w-0 flex-1 items-center gap-2">
              <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-emerald-500/12 text-emerald-700 dark:bg-emerald-400/15 dark:text-emerald-300">
              ...
              <div className="min-w-0">
                ...
                <p className="truncate text-[12px] font-semibold leading-snug text-zinc-500 dark:text-zinc-400">
                  Be seen by others who need help
                </p>
              </div>
            </div>
            <div className="flex shrink-0 items-center gap-1.5">
              <button
                ...
                aria-label="Go live"
              >
                <PlayCircle className="h-6 w-6" strokeWidth={2.5} aria-hidden />
              </button>
              {stripMoreButton}
            </div>
          </div>
