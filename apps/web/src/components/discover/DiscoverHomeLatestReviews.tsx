      ...
      <section className="w-full" aria-label="Latest reviews">
        <div className="flex items-center justify-between gap-3 pb-3 pt-1">
          <div className="min-w-0">
            <h2 className="text-lg font-black tracking-tight text-stone-900 sm:text-xl dark:text-white">
              Latest reviews
            </h2>
  ...
  const renderReviewCard = (
    ...
    return (
      ...
      >
              ...
              <p className="mt-1 truncate text-[13px] font-semibold text-slate-500 dark:text-slate-400">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    !revieweeId &&
                      "pointer-events-none no-underline font-semibold text-slate-500 dark:text-slate-400",
                  )}
                  aria-label={
                    revieweeId
                      ? `Open ${revieweeName} profile`
                      : "Reviewee profile unavailable"
                  }
                >
                  {revieweeName}
        ...
        {variant === "preview" ? (
          <ChevronRight
            className="absolute right-5 top-6 h-5 w-5 shrink-0 text-slate-300 dark:text-slate-600"
            aria-hidden
          />
        ) : null}
      </article>
